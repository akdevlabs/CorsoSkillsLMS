...
BlogContent().then((data) => {  
  ...
  function heroContent(){
    renderTextSection("hero", Policy.hero.Tittle, Policy.hero.Text)
  }
    ...
    function renderAllMedia(jobsObj, containerId) {
      ...
      sortedKeys.forEach(slotKey => {
        ...
        if (typeof slot === 'object' && isSlotFilled(slot)) {
          ...
          renderMediaCard('platform-section', Tittle, Text, link);
        }
      });
    }


    renderAllMedia(Policy.List, 'platform-section');
  }
